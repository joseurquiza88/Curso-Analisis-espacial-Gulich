...
# son datos lattice
# no se tiene que generar una mesh sino una red de vecindarios

# se usa unmodelo besag
# la family cambia de gaussiana, una familia ede poisson inflada con 0
...
formula  <-
  ...
  HogaresHacinamiento +
  HogaresJefe.Univ. + 
  Bancos + # hay dos funciones, dos efectos aleatorios
  f(re_u, model = "besag", graph = g) + #correlacionados espacialmente 
  f(re_v, model = "iid")
